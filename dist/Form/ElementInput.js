...
const ElementInput = props => {
  ...
  let elementData = (0, _reactRedux.useSelector)(state => state.global.elementData);
  let currentData = (0, _reactRedux.useSelector)(state => state.global.currentData);
  const [name, setName] = (0, _react.useState)(""); //const [initialdbOption, setInitialdbOption] = useState(elementData.dboption);

  const [setupData, setSetupData] = (0, _react.useState)();
  ...
  let btnList = [{
    ...
    type: "select",
    optionArray: [{
      text: /*#__PURE__*/_react.default.createElement(_antd2.Button, {
        type: "secondary"
      }, "Line"),
      value: "primary"
    }, {
    ...
    optionArray: [{
      ...
      text: /*#__PURE__*/_react.default.createElement(_antd2.Button, null, "secondary"),
      value: "secondary"
    }, {
      text: /*#__PURE__*/_react.default.createElement(_antd2.Button, {
        danger: true
  ...
  const curr = (0, _react.useMemo)(() => {
    let curr = (0, _lodash.cloneDeep)(currentData);
    ...
    if (lbl) {
      (0, _jquery.default)("#esetup_label").val(lbl);
  ...
  (0, _react.useEffect)(() => {
    ...
    setTimeout(() => {
      (0, _jquery.default)("#esetup_name, #esetup_action").on("keyup change", function (e) {
        e.preventDefault();
        const upc = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1);
        (0, _jquery.default)("#esetup_label").val(upc);
        localStorage.setItem("esetup_label", upc);
      });
      (0, _jquery.default)("#esetup_label").on("click keyup change", function (e) {
        e.preventDefault();
        localStorage.setItem("esetup_label", e.target.value);
      });
    }, 500);
  }, []);
  const [instantView, setInstantView] = (0, _react.useState)(_objectSpread({}, curr));

  const summaryData = eldt => {
    let rule = [],
        eleData = elementData;
    if (eldt) eleData = eldt;
    if (eleData.rules && eleData.rules.length > 0) rule = eleData.rules[0]; //nostyle setting
    ...
    const summaryData1 = {
      setting: {
        ...
        onValuesChange: (changedValues, allValues) => {
          ...
          if (obj === "required") {
            requireobj = {
              required: changedValues[obj]
            };
            if (allValues["requiredmsg"] !== "undefined" && allValues["requiredmsg"] !== "") requireobj = _objectSpread(_objectSpread({}, requireobj), {}, {
              message: allValues["requiredmsg"]
            });
            instantlist = _objectSpread(_objectSpread({}, instant), {}, {
              rules: [requireobj]
            });
            instantView.list = [instantlist];
          } else {
            instantlist = _objectSpread(_objectSpread({}, instant), changedValues);
            instantView.list = [instantlist];
          }
          ...
          if (setupData) {
            const setupinitialValues = _objectSpread(_objectSpread({}, setupData.setting.initialValues), changedValues);
    ...
    switch (type) {
      ...
      case "checkbox.group":
        const optarr = {
          ...
          shouldupdate: true,
          shouldfield: "type",
          shouldvalue: "select,select.multiple,radio.button,radio.group,checkbox.group",
          array: [{
            name: "optionArray",
        ...
        if (elementData.optionArray && elementData.optionArray.length > 0 && typeof elementData.optionArray === "object") {
          elementData.optionArray.map((k, i) => {
            if (k.value === k.text) optsplit += k.value;else optsplit += k.value + "," + k.text;
            if (k.group) optsplit += "," + k.group + ";";else optsplit += ";";
            return null;
          });
        }

        if (optsplit !== "") optsplit = optsplit.slice(0, -1);
        summaryData.setting.initialValues = _objectSpread(_objectSpread({}, summaryData.setting.initialValues), {}, {
      ...
      case "form.list":
        const marks = {
          0: "0%",
          20: "20%",
          50: /*#__PURE__*/_react.default.createElement("strong", null, "50%"),
          80: "80%",
          100: "100%"
        };
  ...
  const SaveChange = () => {
    ...
    if (typeof opt === "string") {
      ...
      opt.split(";").map((k, i) => {
        ...
        if (grp) row = _objectSpread(_objectSpread({}, row), {}, {
          group: grp
        });
    ...
    props.onUpdate(currentData.data); //dispatch(globalVariable({ currentData }));
  };

  const extra = [/*#__PURE__*/_react.default.createElement(_antd2.Tooltip, {
    title: "Save",
    key: "1save"
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    extra: extra,
    ghost: false
  }, setupData && /*#__PURE__*/_react.default.createElement(_AntFormDisplay.default, {
    formArray: setupData,
    form: form,
    name: "esetup"
    ...
    onClick: () => {
      ...
      setTimeout(function () {
        if ((0, _jquery.default)(".ant-modal-confirm-btns>button")) (0, _jquery.default)(".ant-modal-confirm-btns>button").click();
      }, 500);
    }
  }, "Apply")));
};

var _default = ElementInput;
